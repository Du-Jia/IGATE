...
class WrapperConfig(object):
    ...
    def __init__(self,
                 ...
                 eval_every_step=20,
                 info_type: str='max',  # add by du jia.
                 trainable_gamma: bool=True,  # add by du jia
                 gamma: float=0.001,  # add by du jia
                 gamma_i: float=0.001,   # add by du jia
                 gamma_t: float=0.5,   # add by du jia
                 tag: str='base',  # add by du dujia
                 eval_protocl: str='dev32',  # add by dujia
                 use_conv: bool=False,  ## add by du jia.
                 frozen_ptm: bool=False  ## add by du jia.
                 ):
        ...
        self.prompt_dist = None
        self.tag = tag
        self.eval_protocol = eval_protocl
